...
import ChatRecursoUsuario from './ChatRecursoUsuario';

pdfjs.GlobalWorkerOptions.workerSrc = `/pdf.worker.min.js`;

const PdfPreviewUsuario = ({ fileUrl, obj }) => {
      ...
      <div className="row">
        ...
        <div className="col-lg-4">
          <div>
            ...
            {isAuthenticated && (
              <div className="mb-3">
                <ChatRecursoUsuario recursoId={obj.id} titulo={obj.titulo} />
              </div>
            )}
...
export default PdfPreviewUsuario;
