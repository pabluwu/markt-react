...
const EditarServicio = ({ show, setShow, servicio, refetch, idEmpresa }) => {
    ...
    const mutation = useMutation({
        mutationFn: async (data) => {
            console.log('se manda esta dara', data)
            const acc = localStorage.getItem("access_token");
            const response = await fetch(`${api}api/servicios/${servicio.id}/`, {
                method: 'PUT',
                headers: {
    ...
    const content = (
        <>
            <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">Editar servicio N° {servicio.id}</h5>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="modal-footer">
                    <button type="submit" className="btn btn-success mt-3">Editar servicio</button>
